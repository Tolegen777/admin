            ...
            <Grid container>
                <Grid item xs>
                    ...
                    <Box sx={{display: "flex", alignItems: "center"}}>
                        <TextFieldComponent label={"Имя"} value={formik.values.firstName} id="firstName"
                                            name="firstName"
                        ...
                        />
                        {isEdit && <EditIcon sx={{color: "primary.main", marginTop: "25px", marginLeft: "5px"}}
                                             fontSize={"small"}/>}
                    </Box>
                ...
                <Grid item xs>
                    ...
                    <Grid container columnSpacing={3}>
                        ...
                        {isEdit && <EditIcon sx={{color: "primary.main", marginTop: "50px", marginLeft: "5px"}}
                                             fontSize={"small"}/>}
