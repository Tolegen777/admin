...
import {Box, Button, Grid, TableCell, tableCellClasses, TableRow, Typography} from "@mui/material";
...
const WorkerHistory = () => {
    return (
        <Box
            sx={{backgroundColor: "#fff", margin: "20px auto", borderLeft: "20px solid #E4FFF9", padding: "10px 10px"}}>
            <Grid container alignItems="center" direction="row" justifyContent="space-between">
                ...
                <Grid item xs={9} justifyContent={"flex-end"}>
                    <Grid container>
                        ...
                        <Grid item xs={4.9}>
                            <StyledButton startIcon={<ChevronLeftIcon/>}
                                          endIcon={<ChevronRightIcon/>}>Ноябрь</StyledButton>
                        </Grid>
                        <Grid item xs={3.3}>
                            <StyledButton startIcon={<ChevronLeftIcon/>}
                                          endIcon={<ChevronRightIcon/>}>2021</StyledButton>
                        </Grid>
